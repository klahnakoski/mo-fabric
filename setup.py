...
setup(
    ...
    install_requires=["fabric2","invoke","mo-dots>=3.22.19344","mo-files>=3.23.19346","mo-future>=3.17.19324","mo-kwargs>=3.20.19344","mo-logs>=3.21.19344","mo-math>=3.23.19346"],
